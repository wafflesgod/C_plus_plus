...
void displayFileContent() {
    ...
    while (inFile >> storedStudentID >> storedUsername >> storedPassword >> storedGender >> storedDateOfBirth >> storedCourse) {
        cout << "Student ID: " << storedStudentID << "\n";
        cout << "Username: " << storedUsername << "\n";
        cout << "Password: " << storedPassword << "\n";
        cout << "Gender: " << storedGender << "\n";
        cout << "Date of Birth: " << storedDateOfBirth << "\n";
...
void displayMenusignUp() {
    ...
    cin >> studentID; //set the length of password
...
int main() {
    ...
    if (action == 'l' || action == 'L') {
        ...
        displayMenusignUp();
        displayFileContent(); // Add this line to display the content after sign-up
    }
