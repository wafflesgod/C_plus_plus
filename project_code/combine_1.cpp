...
class Counselor{
    ...
    void edit_stdinfo(){
        ...
        ifstream readtest("Std_testlevel_1.txt");
            ...
            if (storedStudentID == enterStudentID){
                ...
                switch (choice){
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        cout << "Error when saving data for student password." << endl;
                        return;
                }
            ...
            if (storedStudentID == enterStudentID){
                ...
                switch (choice){
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        cout << "Error when saving data for student testlevel." << endl;
                        return;
                }
        ...
        remove("Std_testlevel_1.txt");
        rename("test_temp.txt", "Std_testlevel_1.txt");
